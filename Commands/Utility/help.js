...
**:wrench:  Utility:** These commands can be used by every Server member for some work.

**<:ohno:948401869296898118>  Fun:** These commands can be used by every Server member for fun.

**:gun:  Gunsmiths (CoDM):** You can get gunsmiths for any gun by Shadow. (SMGs not updated yet)

**🎟️  Ticket system:** Setup a ticket system for your server.

**:mailbox:  Welcome system:** Setup a welcome message for new members joining your server.
